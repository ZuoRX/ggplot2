...
f16<-read.csv("C:/Users/lenovo/Desktop/BALL/team-NBA/data and code/f16.csv")
f17<-read.csv("C:/Users/lenovo/Desktop/BALL/team-NBA/data and code/f17.csv")
...
x<-barplot(as.matrix(stage1[,2]), beside=T,  #横着并排还是堆叠
